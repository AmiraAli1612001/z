...
const Transfer = () => {
    let data = {
        h1: "Transfer your domain now at very nominal rates",
    ...
    return (
      ...
      <Box className="search">
        <h2>Transfer your domain at competitive prices</h2>
        <p>
        Type the domain name in the field below to view more details about the best rates and suggestions
        </p>
